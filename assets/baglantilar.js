...
export const BAGLANTILAR = [
  ...
  },
  {
    ...
    detay: "İç hat terminali (Terminal 3 veya 1) biletinize göre değişir; şoföre doğru terminali söyleyin.",
    dikkat: "İç hatlarda da kalkıştan 2 saat önce havalimanında olun; öğlen uçuşu için 10:30'da Sakkara'dan çıkmak yeterli.",
  },
  {
    from: "cai-lxr", to: "karnak", tur: "ucak",
    sure: "1 sa uçuş + 25 dk yol", ucret: "160–220 $ (2 kişi, tek yön)",
    ozet: "Luxor'a uçuş ve tapınağa geçiş",
    detay: "EgyptAir ve Nile Air günde birkaç sefer yapıyor; Nile Air genelde daha ucuz. Luxor havalimanı şehre 10 km; taksi 150–250 EGP. Otele valiz bırakıp Karnak'a geçin.",
  ...
  },
  {
    ...
    ozet: "Havalimanına",
    detay: "Otelden valizleri alıp havalimanına geçin. Kalkıştan 2 saat önce orada olun.",
  },
  {
    from: "lxr-ssh", to: "soho", tur: "ucak",
    sure: "1 sa uçuş + 15 dk transfer", ucret: "220–260 $ (2 kişi) + taksi 250–350 EGP",
    ozet: "Kızıldeniz'e iniş",
    detay: "Air Cairo'nun direkt seferi yaklaşık bir saat. Şarm havalimanı Sharks Bay'e 10–15 dakika; önceden ayarlanmış otel transferi (8–15 $) pazarlık derdini sıfırlar.",
    dikkat: "Şarm'da Uber yok; Careem kısıtlı çalışıyor. Havalimanı taksisinde fiyatı binmeden netleştirin.",
  },
  {
    from: "soho", to: "ras-mohammed", tur: "tekne", gunBasi: true,
    sure: "Tam gün, 7–8 saat", ucret: "2 kişi 50–90 $ + park ücretleri ~30 $",
    ozet: "Marinadan Ras Mohammed'e",
    detay: "Tur otobüsü sizi otelden alıp marinaya götürür; tekne Shark ve Yolanda resiflerinde 2–3 şnorkel durağı yapar, öğle yemeği teknede.",
    dikkat: "Milli park girişi (~5 $/kişi) ve marinada nakit ödenen liman ücreti (~10 $/kişi) çoğu pakete dahil değil — rezervasyonda sorun.",
  },
  {
    from: "ras-mohammed", to: "old-market", tur: "taksi",
    sure: "20–25 dk", ucret: "200–300 EGP",
    ozet: "Tekne dönüşü çarşıya",
    detay: "Tur sizi otele bırakır; akşam Old Market'e taksiyle inin. Dönüş için çarşı çıkışındaki taksi sırası ya da otelden ayarlı araç.",
